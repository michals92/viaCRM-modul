define('viacrm:views/fields/base-items', ['views/fields/base'], function (Dep) {
    ...
    return Dep.extend({
        ...
        itemType: 'items', // will be 'offerItems' or 'invoiceItems'
        ...
        selectProduct: function(index) {
            ...
            this.createView('dialog', 'views/modals/select-records', {
                ...
                boolFilterList: [],
                select: ['name', 'price', 'taxRate', 'sku', 'status']
            }, function(view) {
                view.render();
                        ...
                        if (!model.has('taxRate')) {
                            this.getModelFactory().create('ProductsItems', function(productModel) {
                                ...
                                productModel.fetch().then(function() {
                                    ...
                                    this.items[index].isCustom = false;
        ...
        clearProduct: function(index) {
            if (index >= 0 && index < this.items.length) {
                ...
                this.items[index].vat = this.defaultVat;
        ...
        updateCalculations: function() {
            ...
            this.$el.find('.' + this.itemRowClass).each(function(index, row) {
                var $row = $(row);
