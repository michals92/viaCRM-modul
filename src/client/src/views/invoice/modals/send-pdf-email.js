define('viacrm:views/invoice/modals/send-pdf-email', ['views/modals/compose-email'], function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.headerText = this.translate('Send PDF via Email', 'labels', 'Invoice');
        ...
        generatePdfAttachment: function () {
            ...
            Espo.Ajax.postRequest('Invoice/action/generatePdfWithAttachment', {
