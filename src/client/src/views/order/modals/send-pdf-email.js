define('viacrm:views/order/modals/send-pdf-email', ['views/modals/compose-email'], function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.headerText = this.translate('Send PDF via Email', 'labels', 'Order');
        ...
        generatePdfAttachment: function () {
            ...
            Espo.Ajax.postRequest('Order/action/generatePdfWithAttachment', {
                ...
                if (attachment && attachment.id) {
                    ...
                    Espo.Ui.notify(this.translate('PDF attached', 'messages', 'Order'), 'success');
                }
