        ...
        <div class="left">
            ...
            <div class="tabs middle-tabs btn-group">
                {{#each middleTabDataList}}
                    {{#if tabColor}}
                        <style>
                            .btn-group > .btn-text.active[data-tab="{{@key}}"]::after { background-color: {{tabColor}} }
                        </style>
                    {{/if}}
                    <button
                        class="btn btn-text btn-wide{{#if isActive}} active{{/if}}{{#if hidden}} hidden{{/if}}"
                        data-tab="{{@key}}"
                        {{#if tabColor}}style="color: {{tabColor}}"{{/if}}
                    >
                    {{#if tabIconClass}}
                        <span class="{{tabIconClass}}" {{#if tabColor}}style="color: {{tabColor}}"{{/if}}></span>
                    {{/if}}
                    {{label}}
                    </button>
                {{/each}}
