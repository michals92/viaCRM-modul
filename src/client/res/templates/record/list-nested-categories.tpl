{{#unless isLoading}}
    <div class="list-nested-categories">
                ...
                <ul class="dropdown-menu">
                    {{#if showEditLink}}
                        <li>
                            ...
                            ><span class="fas fa-folder-tree fa-sm"></span><span class="item-text">{{translate 'Manage Categories' scope=scope}}</span></a>
                        </li>
                        <li class="divider"></li>
                    {{/if}}
        ...
        <div class="grid-auto-fill-xs">
            {{#each list}}
                <div class="category-cell {{#if color}}has-color{{/if}}" style="{{#if color}}background-color: {{color}};{{/if}}">
                    <div class="category-item" data-id="{{id}}">
                        <a
                            ...
                            data-name="{{name}}"
                            title="{{name}}"
                        ><span class="folder-icon {{#if iconClass}}{{iconClass}}{{else}}far fa-folder{{/if}} text-soft"></span> <span class="category-item-name">{{name}}</span></a>
                    </div>
                </div>
            {{/each}}
            ...
            {{#if showMoreIsActive}}
                <div class="category-cell">
                    <div class="category-item show-more {{#if color}}has-color{{/if}}" style="{{#if color}}background-color: {{color}};{{/if}}">
