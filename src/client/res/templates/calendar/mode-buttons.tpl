    ...
    <ul class="dropdown-menu pull-right">
        ...
        <li>
            <a
                role="button"
                tabindex="0"
                data-action="toggleAllDay"
            >
                <span class="fas fa-check filter-check-icon check-icon pull-right{{#if allDayDisabled}} hidden{{/if}}"></span>
                <div>{{translate 'Toggle All Day' scope='Calendar'}}</div>
            </a>
        </li>
        <li class="divider"></li>
