<div class="order-items-container">
    ...
    .order-items-container .order-item-row:hover {
        border-color: #007bff;
        box-shadow: 0 4px 12px rgba(0,123,255,0.12);
        transform: translateY(-2px);
    }
    .order-items-container .form-group-sm {
        margin-bottom: 8px;
    }
    .order-items-container .item-label {
        font-size: 11px;
        color: #666;
        margin-top: 4px;
        display: block;
    ...
    .order-items-container .btn-toggle-discount {
        background: #fff;
        border-color: #ddd;
        color: #555;
        min-width: 35px;
    ...
    .order-items-container .btn-toggle-discount:hover {
        background: #007bff;
        color: white;
        border-color: #007bff;
    }
    .order-items-container .btn-toggle-discount.active {
        background: #28a745;
        color: white;
        border-color: #28a745;
    }
    .order-items-container .discount-percentage {
        background: #e8f5e8;
        border-color: #28a745;
    }
    .order-items-container .discount-fixed {
        background: #fff3cd;
        border-color: #ffc107;
    }
    .order-items-container .totals-summary {
    ...
    .order-items-container .totals-summary .total-row {
        padding: 6px 12px;
        margin: 2px 0;
        border-radius: 4px;
        transition: background-color 0.2s;
    }
    .order-items-container .totals-summary .total-row:hover {
        background: rgba(0,123,255,0.05);
    }
    .order-items-container .totals-summary .grand-total {
    ...
    .order-items-container .product-selected {
        background: #e8f5e8;
        border-left: 4px solid #28a745;
    }
    .order-items-container .product-custom {
        border-left: 4px solid #ffc107;
    }
    .order-items-container .add-item-section {
        background: #f8f9fa;
    ...
    .order-items-container .add-item-section:hover {
        border-color: #007bff;
        background: #f0f8ff;
    }
    .order-items-container .btn-remove-item:hover {
        background: linear-gradient(135deg, #ff5252, #d32f2f) !important;
        transform: scale(1.1) rotate(90deg);
        box-shadow: 0 4px 16px rgba(211, 47, 47, 0.4) !important;
    }
    .order-items-container .btn-remove-item:active {
    ...
    @media (max-width: 768px) {
        ...
        .order-items-container .order-item-row .col-xs-12 {
            margin-bottom: 12px;
        }
        .order-items-container .totals-summary {
            margin-top: 15px;
    ...
    @media (max-width: 576px) {
        .order-items-container .form-control {
            font-size: 14px;
        }
        .order-items-container .btn {
            font-size: 12px;
            padding: 4px 8px;
        }
    }
    ...
    {{#each items}}
    <div class="order-item-row {{#if isCatalogProduct}}product-selected{{else}}product-custom{{/if}}" data-index="{{@index}}">
    ...
    <div class="add-item-section">
        ...
        <br>
        <small class="text-muted">Klikněte pro přidání nového produktu do této objednávky</small>
    </div>
