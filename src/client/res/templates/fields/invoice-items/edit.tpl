<div class="invoice-items-container">
    ...
    .invoice-items-container .invoice-item-row:hover {
        border-color: #007bff;
        box-shadow: 0 4px 12px rgba(0,123,255,0.12);
        transform: translateY(-2px);
    }
    .invoice-items-container .form-group-sm {
        margin-bottom: 8px;
    }
    .invoice-items-container .item-label {
        font-size: 11px;
        color: #666;
        margin-top: 4px;
        display: block;
    ...
    .invoice-items-container .btn-toggle-discount {
        background: #fff;
        border-color: #ddd;
        color: #555;
        min-width: 35px;
    ...
    .invoice-items-container .btn-toggle-discount:hover {
        background: #007bff;
        color: white;
        border-color: #007bff;
    }
    .invoice-items-container .btn-toggle-discount.active {
        background: #28a745;
        color: white;
        border-color: #28a745;
    }
    .invoice-items-container .discount-percentage {
        background: #e8f5e8;
        border-color: #28a745;
    }
    .invoice-items-container .discount-fixed {
        background: #fff3cd;
        border-color: #ffc107;
    }
    .invoice-items-container .totals-summary {
    ...
    .invoice-items-container .totals-summary .total-row {
        padding: 6px 12px;
        margin: 2px 0;
        border-radius: 4px;
        transition: background-color 0.2s;
    }
    .invoice-items-container .totals-summary .total-row:hover {
        background: rgba(0,123,255,0.05);
    }
    .invoice-items-container .totals-summary .grand-total {
    ...
    .invoice-items-container .product-selected {
        background: #e8f5e8;
        border-left: 4px solid #28a745;
    }
    .invoice-items-container .product-custom {
        border-left: 4px solid #ffc107;
    }
    .invoice-items-container .add-item-section {
        background: #f8f9fa;
    ...
    .invoice-items-container .add-item-section:hover {
        border-color: #007bff;
        background: #f0f8ff;
    }
    .invoice-items-container .btn-remove-item:hover {
        background: linear-gradient(135deg, #ff5252, #d32f2f) !important;
        transform: scale(1.1) rotate(90deg);
        box-shadow: 0 4px 16px rgba(211, 47, 47, 0.4) !important;
    }
    .invoice-items-container .btn-remove-item:active {
    ...
    @media (max-width: 768px) {
        ...
        .invoice-items-container .invoice-item-row .col-xs-12 {
            margin-bottom: 12px;
        }
        .invoice-items-container .totals-summary {
            margin-top: 15px;
    ...
    @media (max-width: 576px) {
        .invoice-items-container .form-control {
            font-size: 14px;
        }
        .invoice-items-container .btn {
            font-size: 12px;
            padding: 4px 8px;
        }
    }
    ...
    {{#each items}}
    <div class="invoice-item-row {{#if isCatalogProduct}}product-selected{{else}}product-custom{{/if}}" data-index="{{@index}}">
