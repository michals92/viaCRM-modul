{{#if params.compact}}
<div class="input-group input-group-link-parent compact">
    {{#if foreignScopeList.length}}
    <span class="input-group-item compact">
        <select class="form-control radius-left" data-name="{{typeName}}">
            {{options foreignScopeList foreignScope category='scopeNames'}}
        </select>
    </span>
    <span class="input-group-item input-group-item-middle compact">
        <input
    ...
    <span class="input-group-btn compact">
        <button
